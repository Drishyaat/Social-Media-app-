...
import { wizardLogo } from "../../utils/constants";
        ...
        <div className="flex sm:items-start justify-center px-5 py-15 sm:py-4 sm:flex-col gap-3 sm:gap-2 tracking-wide grow space-y-1.5">
          <li className="flex items-center">
            <Link to="/" className="flex items-center">
              <img
                ...
                className="w-6 h-6"
              />
              <span className="ml-2 font-bold text-2xl p-2 text-blue-700">
               Wizardagram
              </span>
            </Link>
          </li>
          ...
          <li className="flex items-center">
            <NavLink className="flex items-center">
              <button
                className="flex items-center px-4 py-2 rounded-md transition-colors duration-300 ease-in-out bg-blue-400 text-white hover:bg-blue-500 hover:text-white"
                onClick={openModal}
              >
