  ...
  return (
    <div className=" flex flex-row w-full p-3">
      ...
      <div className="flex flex-col w-full m-2">
        <textarea
          placeholder="Share with wizarding world!"
          value={newPostDetails?.content}
          className="focus:outline-blue-400 focus:outline-double border border-blue-400 p-1"
          rows={2}
          onChange={(e) =>
        ...
        <div className="flex flex-row justify-end items-center py-2">
          ...
          <button
            className="flex items-center px-5 ml-3 h-8 transition-colors duration-300 ease-in-out bg-blue-400 text-white hover:bg-blue-500 hover:text-white rounded-md"
